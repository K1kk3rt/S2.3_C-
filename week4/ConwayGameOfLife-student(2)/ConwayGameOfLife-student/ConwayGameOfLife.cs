...
namespace ConwayGameOfLife
{
    public abstract class ConwayGameOfLife
    {
        ...
        public ConwayGameOfLife()
        {
            ...
            //default life
            life = new StandardLifeBehaviour();
        ...
        public void Evolve()
        {
            ...
            for (int r = 0; r < HEIGHT; r++)
            {
                ...
                for (int c = 0; c < WIDTH; c++)
                {
                    ...
                    livingCell = copySpace[r, c];

                    // get number of live (surrounding) cells
                    neighBourCount = GetLiveNeighbours(copySpace, r, c);



                    // cell should live?
                    this.space[r, c] = life.IsLife(livingCell, neighBourCount);
                }
            }
        }
